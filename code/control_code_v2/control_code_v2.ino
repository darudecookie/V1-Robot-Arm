...
{
public:
  bool all_Joint_hold = false; // whether or not joint hold is currently on. should probably be global tbh
  ...
  JointHold()
  {
    Serial.println("intializing joint hold handler object");
    Serial.print("current joint hold status: ");
    (all_Joint_hold) ? Serial.println("on") : Serial.println("off");
  }

private:
  long last_time = 0;                   // last time func. was run
...
void setup()
{
  ...
  JointHold_handler = new JointHold();
